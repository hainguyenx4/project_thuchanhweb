 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">Đôi Điều SUN RISE</h3> 
						   <p class="about-para-w3ls">Khởi đầu với đội ngũ thô sơ nhưng với tinh thần, ý chí cầu tiến, quyết tâm không ngừng nghỉ, SUN RISE đang ngày càng lớn mạnh với phương châm: "có tiền là có tất cả".</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		<h4>Nhà Hàng Phục Vụ 24/24</h4>
			 		<p>Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates.</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Phục Vụ Phòng 24/24</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Hướng Dẫn Khách 24/24</p>
			 	</div>
			 </div>
			<div class="clearfix"> </div>
			</div>
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Đội Ngũ</h3>
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Nguyen Dinh Khanh Hai</h4>
							<span>Manager</span>
							<p>Don't mix bad words with a bad mood. You'll have many opportunities to change a mood, but you won't be able to replace words you spoke .</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>Art is the beautiful way of doing things. Science is the effective way of doing things. Business is the economic way of doing things. .</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Phòng Trưng Bày</h3>
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Loại Phòng Và Đánh Giá</h3>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>$</span>320</h3>						
								<a href="admin/reservation.php" >Đặt Phòng</a>
							</div>
						</div>
					</div>
				</div>
  ...
  <!-- visitors -->
	<div class="w3l-visitors-agile" >
		<div class="container">
                 <h3 class="title-w3-agileits title-black-wthree">Du khách review</h3> 
		</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+84 123456789</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Tran Dai Nghia street, Ha Noi, Viet Nam</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2019 SUNRISE . All Rights Reserved | Design by <a href="index.php">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
